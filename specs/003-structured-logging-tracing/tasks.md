...
- [ ] T024 [P] Add pack export/delete logging: pack_export_started/finished (INFO), pack_delete_started/finished (INFO) in `crates/tauri-bridge/src/commands/pack_commands.rs`
- [ ] T025 [P] Add doctor logging: doctor_started/finished (INFO, score, issue counts) in `crates/tauri-bridge/src/commands/doctor_commands.rs`
- [ ] T026 [P] Add structured error logging for failed operations: include error code, operation_id, module name, entity IDs in `crates/tauri-bridge/src/commands/migration_commands.rs` and `crates/tauri-bridge/src/commands/repo_commands.rs`

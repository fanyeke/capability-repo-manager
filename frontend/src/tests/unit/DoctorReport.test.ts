    ...
    const issues: DoctorIssue[] = [
      {
        severity: 'critical',
        code: 'MISSING_HOOK',
        message: 'Missing pre-commit hook',
        resource_ref: null,
        recommendation: null,
      },
      {
    ...
    const issues: DoctorIssue[] = [
      {
        severity: 'critical',
        code: 'MISSING_HOOK',
        message: 'Pre-commit hook is missing',
        resource_ref: null,
        recommendation: null,
      },
    ];
    ...
    const issues: DoctorIssue[] = [
      {
        ...
        message: 'Old skill format',
        resource_ref: null,
        recommendation: 'Migrate to new format',
      },
    ];
    const report = makeReport(80, issues);
    const { container } = render(DoctorReport, { props: { report } });
    ...
    const issues: DoctorIssue[] = [
      {
        ...
        resource_ref: '.claude/skills/test',
        recommendation: null,
      },
    ];
